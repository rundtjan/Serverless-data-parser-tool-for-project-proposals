...
module.exports = async (event) => {
    ...
    try {
        ...
        return `Please find your parsed data with the parameters: channel = ${parsedParams.channel}, user = ${parsedParams.user || 'not chosen'} and timelimit = ${parsedParams.hours + ' hrs' || 'not chosen'}. See the result at https://test-aws.d2fgc3zkz3vtk1.amplifyapp.com/${queryParams.substring(0,queryParams.length-1)}`
    } catch (error) {
        console.log(error)
